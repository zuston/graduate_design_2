...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table">
                    <caption>列表详情<button class="btn btn-primary btn-xs add-new-button" style="float: right;"><a href="/addPeople?type=1" style="color: #ffffff;">新增销售商</a></button></caption>
                    <thead>
                    <tr>
                        <th>编号</th>
                        <th>销售商名</th>
                    ...
                    <?php foreach($providers as $key => $u1){ ?>
                        <tr class="<?php echo $table_type[$key%3];?>">
                            <td class="id"><?php echo $u1->customer_id;?></td>
                            <td><?php echo $u1->customer_company_name;?></td>
                            <td><?php echo $u1->customer_company_phone;?></td>
                            <td><?php echo $u1->customer_contact_name;?></td>
                            <td><?php echo $u1->customer_contact_phone;?></td>
                            <td><?php echo $u1->customer_contact_qq;?></td>
                            <td><?php echo $u1->customer_contact_address;?></td>
                            <td>
