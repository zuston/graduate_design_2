...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">修改< <?php echo $userModel -> user_name;?> >的信息</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <div class="row">
            <div class="col-md-6">
                <form role="form" action="/modify/userManage" method="post">
                    <div class="form-group">
                        <label>编号</label>
                        <input class="form-control" value="<?php echo $userModel->id;?>" name="user_id" >
